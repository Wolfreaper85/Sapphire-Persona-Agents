...
def generate_skills(persona_name):
    ...
    Analyzes which tools the persona has and creates a starter
    skills definition with role, tool guidelines, and boundaries.
    """
    persona_name = persona_name.lower().strip()
    ...
    if not has_smarthome:
        pass  # Don't mention smart home unless relevant
